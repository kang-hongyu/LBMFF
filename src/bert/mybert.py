...
class InputExample(object):
  ...
  def __init__(self, guid, words1, words2, label=None):
    ...
    def _read_data(cls,input_file):
        ...
        with open(input_file, encoding='utf-8') as rf:
            for line in rf:
                ...
                words1 = pieces[0].split(" ")
                words2 = pieces[1].split(" ")
                label = pieces[2]
                lines.append((words1, words2, label))
        return lines
...
class ClassProcessor(DataProcessor):
    ...
    def _create_example(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            guid = "%s-%s" % (set_type, i)
            words1 = tokenization.convert_to_unicode(line[0])
            words2 = tokenization.convert_to_unicode(line[1])
            labels = line[2]
            examples.append(InputExample(guid=guid, words1=words1, words2=words2, label=labels))
        return examples
